  ...
  return (
    <>
      <div className="news-card">
        <img src={image_04} alt="#" className="news-card__image" />
      ...
      <div className="news-card">
        <img src={image_07} alt="#" className="news-card__image" />
        <button type="button" className="news-card__save" />
        <div className="news-card__publication-date">2 августа, 2019</div>
      ...
      <div className="news-card">
        <img src={image_08} alt="#" className="news-card__image" />
        <button type="button" className="news-card__save" />
        <div className="news-card__publication-date">2 августа, 2019</div>
    ...
    // <div  className="news-card">
    //   <img src={card.link} alt={card.name} className="news-card__image" />
    //   <button type="button" className="news-card__save" />
    //   <div className="news-card__publication-date" />
    //   <h3 className="news-card__title">{card.name}</h3>
    //   <p className="news-card__text">{card.text}</p>
    //   <p className="news-card__channel">{card.channel}</p>
    // </div>
  );
};
